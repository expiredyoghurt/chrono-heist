 ...
 *      Workers AI features — using KV and Workers AI bindings.
 *
 ...
 *
 * Required bindings (names must match EXACTLY — set via the dashboard,
 * see README.md → "Reconnecting the AI-powered backend features"):
 *   ASSETS           (Static Assets — configured via wrangler.toml, not
 *                      the dashboard; see wrangler.toml in this repo)
